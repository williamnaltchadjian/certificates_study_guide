...
### ⚠️ Riscos de Segurança em Prompts
...
## 🏗️ 3.3 — Treinamento e Ajuste Fino
...
| :--- | :--- | :--- |
| **1️⃣** | Melhorar o Prompt | Sempre tente primeiro |
| **2️⃣** | Usar RAG | Dados precisam ser atualizados ou privados |
| **3️⃣** | Fine-tuning | Domínio muito específico |
| **4️⃣** | Treinar do zero | Quase nunca — custo altíssimo |
