...
O k-NN plugin (k-Nearest Neighbors) no Amazon OpenSearch Service é uma funcionalidade que permite realizar pesquisas de similaridade vetorial em grandes volumes de dados. Ele permite encontrar os "vizinhos mais próximos" de um ponto de dados em um espaço vetorial, utilizando algoritmos como a distância euclidiana ou a similaridade de cosseno. 
