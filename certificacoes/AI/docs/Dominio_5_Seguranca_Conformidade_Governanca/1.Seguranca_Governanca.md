...
=== "Exemplo 1"
    **"Uma empresa quer garantir que seu modelo não gere decisões enviesadas."**

    Resposta → **Amazon SageMaker Clarify**

=== "Exemplo 2"
    **"Empresa precisa de revisão humana em decisões sensíveis."**

    Resposta → **Amazon Augmented AI (A2I)**

=== "Exemplo 3"
    **"Proteger dados sensíveis armazenados em buckets S3."**

    Resposta → **Criptografia com KMS + Amazon Macie**

=== "Exemplo 4"
    **"Auditar todas as ações realizadas na conta AWS."**
